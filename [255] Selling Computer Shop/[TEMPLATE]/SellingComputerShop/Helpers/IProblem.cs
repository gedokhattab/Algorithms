...
namespace Helpers
{
    public interface IProblem
    {
        ...
        /// <param name="rootFolder">root folder of the test cases (if "", then it's the Debug/Release folder)</param>
        void Run(HardniessLevel level, int timeOutInMillisec, string rootFolder = "");
